"""
Este módulo contiene una clase para calcular el Mínimo Común Múltiplo (MCM)
utilizando el Máximo Común Divisor (MCD).
"""

class CalculadoraMCM:
    """
    Clase para calcular el Mínimo Común Múltiplo (MCM) utilizando el Máximo Común Divisor (MCD).
    """
    def __init__(self):
        pass
